...
return array(
		...
		'For the access to the express cargo tracking system please insert your Order Identification Number' => 'Для того чтобы узнать текущее местонахождение Вашего груза введите Уникальный идентификационный номер Вашей отправки',
		'JSC «Sovtransavtoexpedition»' => 'ОАО «Совтрансавтоэкспедиция»',
