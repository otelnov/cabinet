<div class="view">
	...
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('varname')); ?>:</b>
	<?php echo CHtml::encode($data->varname); ?>
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('title')); ?>:</b>
	<?php echo CHtml::encode($data->title); ?>
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('field_type')); ?>:</b>
	<?php echo CHtml::encode($data->field_type); ?>
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('field_size')); ?>:</b>
	<?php echo CHtml::encode($data->field_size); ?>
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('field_size_min')); ?>:</b>
	<?php echo CHtml::encode($data->field_size_min); ?>
	<br /> <b><?php echo CHtml::encode($data->getAttributeLabel('required')); ?>:</b>
